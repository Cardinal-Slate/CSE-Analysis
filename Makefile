# Makefile — CSE-Analysis: reals as enclosures over ℚ, type-first. A value carries the Real tag and stacks
# concretely on Arith; there is no field. Depends on spine + CSE-DSA + CSE-Types + CSE-Arith.
#
...
$(OUT)/test_analysis: tests/analysis.c $(OBJS) | $(OUT)
	@$(CC) $(TFLAGS) tests/analysis.c $(OBJS) $(DEPLIBS) -o $@
